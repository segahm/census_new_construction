...
#     sql_on: |
#       ${ages_regions.year_indx} = ${property.year}
#       AND
#       ${ages_regions.region} = ${property.region}
  ...
  - join: square_feet_completed
    ...
    sql_on: |
      ${ages_regions.year_indx} = ${square_feet_completed.year}
      AND
  ...
  - join: square_feet_completed_medavg
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${square_feet_completed_medavg.year}
      AND
  ...
  - join: bedrooms_total
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${bedrooms_total.year}
      AND
  ...
  - join: bedrooms_owner
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${bedrooms_owner.year}
      AND
  ...
  - join: bedrooms_for_sale
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${bedrooms_for_sale.year}
      AND
  ...
  - join: bedrooms_contract
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${bedrooms_contract.year}
      AND
  ...
  - join: ac_build_4sale
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${ac_build_4sale.year}
      AND
...
#       ${property.type} = 'AC Built for Sale'
  ...
  - join: ac_completed
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${ac_completed.year}
      AND
...
#       ${property.type} = 'AC Completed'
  ...
  - join: ac_contractor_build
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${ac_contractor_build.year}
      AND
...
#       ${property.type} = 'AC Contractor Build'      
  ...
  - join: finance_built_forsale
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${finance_built_forsale.year}
      AND
...
#       ${property.type} = 'Financial Built for Sale'
  ...
  - join: finance_contractorbuilt
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${finance_contractorbuilt.year}
      AND
...
#       ${property.type} = 'Financial Contractor Built'
  ...
  - join: finance_owner_built
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${finance_owner_built.year}
      AND
...
#       ${property.type} = 'Financial Owner Built'
  ...
  - join: financial_completed
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${financial_completed.year}
      AND
...
#       ${property.type} = 'Financial Completed'      
  ...
  - join: age_resticted_completed
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${age_resticted_completed.year}
      AND
...
#       ${property.type} = 'Age Restricted Completed'
  ...
  - join: bathroom_completed
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${bathroom_completed.year}
      AND
...
#       ${property.type} = 'Bathroom Completed'
  ...
  - join: bathroom_contractorbuilt
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${bathroom_contractorbuilt.year}
      AND
...
#       ${property.type} = 'Bathroom Contractor Built'
  ...
  - join: age_rest_builtforsale
    relationship: one_to_one
    sql_on: |
      ${ages_regions.year_indx} = ${age_rest_builtforsale.year}
      AND
